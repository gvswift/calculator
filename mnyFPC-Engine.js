...
function calculation(){
    ...
    switch(hd.value){
        case "8701":
            ...
            /* surcharge */
            baseSurcharge = 0;
            document.getElementById("vs-amount").innerText = baseSurcharge.toFixed;
            /* rates */
        ...
        case "8702":
            /* surcharge */
             a = ageFactors8702_8704.findLastIndex((vehicle) => vehicle.age <=Number(v_age.value));
             s = seatingFactors8702.findLastIndex((vehicle) => vehicle.seats <= Number(seating.value));
             c = cifMatrix8702.findIndex((vehicle) => vehicle.cif <= cifec);
        ...
        case "8703":
            /* surcharge  */
             a = ageFactors8703.findLastIndex((vehicle) => vehicle.age <= Number(v_age.value));
            c = cifMatrix8703.findIndex((vehicle) => vehicle.cif <= cifec); 
      
            cifFactor = cifMatrix8703[c].factors[a]; 
       
            if(source.value === "gas" || source.value === "diesel" || source.value === "hybrid") {
                   c = engineSizeFactors8703.findLastIndex((vehicle) => vehicle.ccs <= Number(cc.value));
                  ...
                  baseSurcharge = surcharge_base * age_factor * engineSizeFactor * cifFactor;
                   ...
                   r = rangeFactors8703.findIndex((vehicle) => vehicle.range <= Number(cc.value)); 
        ...
        case "8704":
            /* surcharge */
             a = ageFactors8702_8704.findLastIndex((vehicle) => vehicle.age <= Number(v_age.value));
             t = tonnageFactors8704.findLastIndex((vehicle) => vehicle.tons <= Number(tonnage.value));
             c = cifMatrix8704.findIndex((vehicle) => vehicle.cif <= cifec);
            ...
            if(source.value ==="electric" || source.value === "hybrid"){
                        ...
                        baseVATRate = 16.00;
                               ...
                               t = cargo_8704.findLastIndex((vehicle) => vehicle.ton <= Number(tonnage.value));
        ...
        case "8705":
            ...
            if (option.value === "fire_fighting"){
                 a = ageFactors8705.findLastIndex((vehicle) => vehicle.age <= Number(v_age.vage));
                 c = cifMatrix8705.findIndex((vehicle) => vehicle.cif <= cifec);
                ...
                baseSurcharge = surcharge_base * age_factor * cifFactor;
                 ...
                 a = ageFactors8705.findLastIndex((vehicle) => vehicle.age <=Number(v_age.value));
                 c = cifMatrix8705.findIndex((cif) => cif <= cifec);
